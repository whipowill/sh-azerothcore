-- Use ingame commands to change seasons:
-- .event start 75 -- season 1
-- .event start 76 -- season 2
-- .event start 55 -- season 3
-- .event start 56 -- season 4 (this makes vendors in Org/Storm useless? why?)
